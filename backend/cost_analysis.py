"""cost_analysis.py — merge finding_rules + OpenAI into one cost analysis."""
...
from finding_score import canonical_category, group_by_resource
...
def analyze_resources(
    ...
    resources : list[dict]
        The list of normalised resource objects from resource_inventory.
